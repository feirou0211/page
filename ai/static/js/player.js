/*! @vimeo/player v2.20.1 | (c) 2023 Vimeo | MIT License | https://github.com/vimeo/player.js */ ! function(e, t) {
    ...
    function j() {
        ...
        function u(e, t, n, r) {
            var i, a, u, c, o = t && t.prototype instanceof p ? t : p,
                l = Object.create(o.prototype),
                s = new x(r || []);
            return f(l, "_invoke", {
                value: (i = e, a = n, u = s, c = "suspendedStart", function(e, t) {
                    ...
                    for (u.method = e, u.arg = t;;) {
                        ...
                        if (n) {
                            var r = function e(t, n) {
                                var r = n.method,
                                    o = t.iterator[r];
                                if (void 0 === o) return n.delegate = null, "throw" === r && t.iterator.return && (n.method = "return", n.arg = void 0, e(t, n), "throw" === n.method) || "return" !== r && (n.method = "throw", n.arg = new TypeError("The iterator does not provide a '" + r + "' method")), h;
                                var i = d(o, t.iterator, n.arg);
                                if ("throw" === i.type) return n.method = "throw", n.arg = i.arg, n.delegate = null, h;
                                var a = i.arg;
                                return a ? a.done ? (n[t.resultName] = a.value, n.next = t.nextLoc, "return" !== n.method && (n.method = "next", n.arg = void 0), n.delegate = null, h) : a : (n.method = "throw", n.arg = new TypeError("iterator result is not an object"), n.delegate = null, h)
                            }(n, u);
                            if (r) {
                                if (r === h) continue;
                                return r
                        ...
                        var o = d(i, a, u);
                        if ("normal" === o.type) {
                            if (c = u.done ? "completed" : "suspendedYield", o.arg === h) continue;
                            return {
                                value: o.arg,
                                done: u.done
                            }
        ...
        return f(g, "constructor", {
            ...
            value: c,
            configurable: !0
        }), c.displayName = i(l, r, "GeneratorFunction"), a.isGeneratorFunction = function(e) {
            var t = "function" == typeof e && e.constructor;
            return !!t && (t === c || "GeneratorFunction" === (t.displayName || t.name))
        }, a.mark = function(e) {
            return Object.setPrototypeOf ? Object.setPrototypeOf(e, l) : (e.__proto__ = l, i(e, r, "GeneratorFunction")), e.prototype = Object.create(g), e
        }, a.awrap = function(e) {
            return {
                __await: e
            }
        }, w(b.prototype), i(b.prototype, n, function() {
            return this
        }), a.AsyncIterator = b, a.async = function(e, t, n, r, o) {
            void 0 === o && (o = Promise);
            var i = new b(u(e, t, n, r), o);
            return a.isGeneratorFunction(t) ? i : i.next().then(function(e) {
                return e.done ? e.value : i.next()
            })
        }, w(g), i(g, r, "Generator"), i(g, o, function() {
            return this
    ...
    function v(n) {
        ...
        return function() {
            ...
            return function(e, t) {
                ...
                return p(e)
            }(this, r ? (e = i(this).constructor, Reflect.construct(t, arguments, e)) : t.apply(this, arguments))
        }
    }
    ...
    function C(e, t) {
        if (!F(e) || !T.call(e, "_id")) throw new TypeError(t + " method called on incompatible receiver " + typeof e)
    }
    ...
    function F(e) {
        ...
        if (C(this, "set"), !F(e)) throw new TypeError("Invalid value used as weak map key");
        var n = e[this._id];
    ...
    var L, A = (function(e) {
            ...
            }, (n = M)[t = "Promise"] = n[t] || r(), e.exports && (e.exports = n[t])
        }(L = {
            exports: {}
        }), L.exports),
        R = new WeakMap;
    ...
    function V(e, t, n) {
        ...
        var o = r[t].indexOf(n);
        return -1 !== o && r[t].splice(o, 1), R.set(e.element, r), r[t] && 0 === r[t].length
    }
    ...
    function z(n, r) {
        ...
        }), o = I(n, "event:".concat(r.event)), t = r.data) : !r.method || (e = function(e, t) {
            var n = I(e, t);
    ...
    function H(i, e, t) {
        ...
        return new Promise(function(t, n) {
            if (!g(i)) throw new TypeError("“".concat(i, "” is not a vimeo.com url."));
            ...
            o.open("GET", e, !0), o.onload = function() {
                if (404 !== o.status)
                    if (403 !== o.status) try {
                        ...
                        if (403 === e.domain_status_code) return B(e, u), void n(new Error("“".concat(i, "” is not embeddable.")));
                        t(e)
                    } catch (e) {
                        n(e)
    ...
    var Y, Q, J, X = {
        ...
        $ = function() {
            ...
            function a(e, t) {
                ...
                return l(this, a), s(p(o = i.call(this)), "logger", void 0), s(p(o), "speedAdjustment", 0), s(p(o), "adjustSpeed", function() {
                ...
                }()), o.logger = r, o.init(t, e, u(u({}, X), n)), o
            }
            return e(a, [{
                key: "disconnect",
                value: function() {
                ...
                value: (r = h(j().mark(function e(t, n, r) {
                    ...
                    return j().wrap(function(e) {
                        for (;;) switch (e.prev = e.next) {
                            case 0:
                                if (o = t.query(), i = o.position, a = o.velocity, "number" == typeof i && n.setCurrentTime(i), "number" != typeof a) {
                                    e.next = 25;
                                    break
                                }
                                ...
                                return j().wrap(function(e) {
                                    for (;;) switch (e.prev = e.next) {
                                        ...
                                        case 6:
                                            ...
                                            break;
                                        case 8:
                                            return e.t2 = a.query().position, e.next = 11, u.getCurrentTime();
                                        case 11:
                                            if (e.t3 = e.sent, t = e.t2 - e.t3, n = Math.abs(t), c.log("Drift: ".concat(t)), s < n) return e.next = 18, c.adjustSpeed(u, 0);
                                            e.next = 22;
                                            break;
                                        case 18:
                                            u.setCurrentTime(a.query().position), c.log("Resync by currentTime"), e.next = 29;
                                            break;
                                        case 22:
                                            if (l < n) return i = (r = n / d) < (o = f) ? (o - r) / 2 : o, e.next = 28, c.adjustSpeed(u, i * Math.sign(t));
                                            e.next = 29;
                                            break;
                                        case 28:
        ...
        Player = function() {
            function Player(u) {
                ...
                if (l(this, Player), window.jQuery && u instanceof jQuery && (1 < u.length && window.console && console.warn && console.warn("A jQuery object with multiple elements was passed, using the first element."), u = u[0]), "undefined" != typeof document && "string" == typeof u && (u = document.getElementById(u)), e = u, !Boolean(e && 1 === e.nodeType && "nodeName" in e && e.ownerDocument && e.ownerDocument.defaultView)) throw new TypeError("You must pass either a valid element or a valid id.");
                if ("IFRAME" === u.nodeName || (t = u.querySelector("iframe")) && (u = t), "IFRAME" === u.nodeName && !g(u.getAttribute("src") || "")) throw new Error("The player element passed isn’t a Vimeo embed.");
                ...
                var r, o = new A(function(i, a) {
                    ...
                    }, c._window.addEventListener("message", c._onMessage), "IFRAME" !== c.element.nodeName && H(b(e = G(u, n)), e, u).then(function(e) {
                        var t, n, r, o = B(e, u);
                        return c.element = o, c._originalElement = u, t = u, n = o, r = R.get(t), R.set(n, r), R.delete(t), K.set(c.element, c), e
                    }).catch(a)
                });
                return Z.set(this, o), K.set(this.element, this), "IFRAME" === this.element.nodeName && W(this, "ping"), ee.isEnabled && (r = function() {
                    return ee.exit()
                }, this.fullscreenchangeHandler = function() {
                    (ee.isFullscreen ? q : V)(c, "event:exitFullscreen", r), c.ready().then(function() {
            ...
            return e(Player, [{
                ...
                value: function(n) {
                    var r = this;
                    return new A(function(e, t) {
                        return n = m(n, "get"), r.ready().then(function() {
                            q(r, n, {
                                resolve: e,
                                reject: t
                            }), W(r, n)
                ...
                value: function(n, r) {
                    var o = this;
                    return new A(function(e, t) {
                        if (n = m(n, "set"), null == r) throw new TypeError("There must be a value to set.");
                ...
                value: function(e, t) {
                    ...
                    0 === I(this, "event:".concat(e)).length && this.callMethod("addEventListener", e).catch(function() {}), q(this, "event:".concat(e), t)
                }
            }, {
                key: "off",
                value: function(e, t) {
                ...
                value: function() {
                    ...
                    return new A(function(e) {
                        var t;
                        Z.delete(n), K.delete(n.element), n._originalElement && (K.delete(n._originalElement), n._originalElement.removeAttribute("data-vimeo-initialized")), n.element && "IFRAME" === n.element.nodeName && n.element.parentNode && (n.element.parentNode.parentNode && n._originalElement && n._originalElement !== n.element.parentNode ? n.element.parentNode.parentNode.removeChild(n.element.parentNode) : n.element.parentNode.removeChild(n.element)), n.element && "DIV" === n.element.nodeName && n.element.parentNode && (n.element.removeAttribute("data-vimeo-initialized"), (t = n.element.querySelector("iframe")) && t.parentNode && (t.parentNode.parentNode && n._originalElement && n._originalElement !== t.parentNode ? t.parentNode.parentNode.removeChild(t.parentNode) : t.parentNode.removeChild(t))), n._window.removeEventListener("message", n._onMessage), ee.isEnabled && ee.off("fullscreenchange", n.fullscreenchangeHandler), e()
                    })
                }
            }, {
                key: "getAutopause",
                ...
                value: (n = h(j().mark(function e(t, n) {
                    ...
                    return j().wrap(function(e) {
                        for (;;) switch (e.prev = e.next) {
                            ...
                            case 4:
                                return r = new $(this, t, n), W(this, "notifyTimingObjectConnect"), r.addEventListener("disconnect", function() {
    ...
    return n || (Y = function() {
        ...
        exit: function() {
            return new Promise(function(t, e) {
                ...
                }, J.on("fullscreenchange", n), (r = document[Y.exitFullscreen]()) instanceof Promise && r.then(n).catch(e)) : t()
            })
        },
        on: function(e, t) {
            var n = Q[e];
