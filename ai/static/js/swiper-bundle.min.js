! function(e, t) {
    ...
    class X {
        constructor() {
            ...
            const l = g({}, G, n);
            return r.params = g({}, l, H, t), r.originalParams = g({}, r.params), r.passedParams = g({}, t), r.params && r.params.on && Object.keys(r.params.on).forEach((e => {
    ...
    const J = [function(e) {
        ...
        function p() {
            ...
            if ("fraction" === s.type && (r.find(R(s.currentClass)).text(s.formatFractionCurrent(p + 1)), r.find(R(s.totalClass)).text(s.formatFractionTotal(u))), "progressbar" === s.type) {
                ...
                let i = 1,
                    n = 1;
                "horizontal" === e ? i = a : n = a, r.find(R(s.progressbarFillClass)).transform(`translate3d(0,0,0) scaleX(${i}) scaleY(${n})`).transition(t.params.speed)
            }
        ...
        function u() {
            ...
            if ("bullets" === e.type) {
                ...
                a.html(r), t.pagination.bullets = a.find(R(e.bulletClass))
            }
        ...
        function m() {
            ...
            s.removeClass(e.hiddenClass), s.removeClass(e.modifierClass + e.type), s.removeClass(t.isHorizontal() ? e.horizontalClass : e.verticalClass), t.pagination.bullets && t.pagination.bullets.removeClass && t.pagination.bullets.removeClass(e.bulletActiveClass), e.clickable && s.off("click", R(e.bulletClass))
        }
        a("init", (() => {
            h(), u(), p()
        })), a("activeIndexChange", (() => {
        ...
        a("beforeInit", (() => {
            ...
            t.params.a11y.enabled && function() {
                ...
                })), t.navigation && t.navigation.$nextEl && (f = t.navigation.$nextEl), t.navigation && t.navigation.$prevEl && (b = t.navigation.$prevEl), f && f.length && v(f, r, e.nextSlideMessage), b && b.length && v(b, r, e.prevSlideMessage), g() && t.pagination.$el.on("keydown", R(t.params.pagination.bulletClass), m), t.$el.on("focus", w, !0)
            }()
            ...
            t.params.a11y.enabled && function() {
                let e, s;
                i && i.length > 0 && i.remove(), t.navigation && t.navigation.$nextEl && (e = t.navigation.$nextEl), t.navigation && t.navigation.$prevEl && (s = t.navigation.$prevEl), e && e.off("keydown", m), s && s.off("keydown", m), g() && t.pagination.$el.off("keydown", R(t.params.pagination.bulletClass), m), t.$el.off("focus", w, !0)
            }()
        }))
    }, function(e) {
        let {
        ...
        const p = () => {
            ...
            u = () => {
                if (l && t.params.hashNavigation.enabled)
                    if (t.params.hashNavigation.replaceState && c.history && c.history.replaceState) c.history.propertyIsEnumerable(null, null, `#${t.slides.eq(t.activeIndex).attr("data-hash")}` || ""), i("hashSet");
                    else {
        ...
        Object.assign(t, {
            appendSlide: W.bind(t),
            prependSlide: j.bind(t),
            addSlide: _.bind(t),
            removeSlide: q.bind(t),
            removeAllSlides: V.bind(t)
        })
    }, function(e) {
        let {
            swiper: t,
        ...
        s({
            ...
            setTransition: e => {
                ...
                (s ? t.slides.find(s) : t.slides).transition(e), K({
                    swiper: t,
                    duration: e,
                    transformEl: s,
                    allSlides: !0
        ...
        s({
            ...
            setTranslate: () => {
                ...
                for (let i = 0; i < e.length; i += 1) {
                    ...
                    if (t.isHorizontal() ? s && (o = -o) : (p = c, c = 0, d = -o, o = 0), r[0].style.zIndex = -Math.abs(Math.round(n)) + e.length, a.slideShadows) {
                        ...
                        0 === e.length && (e = Z(a, r, t.isHorizontal() ? "left" : "top")), 0 === s.length && (s = Z(a, r, t.isHorizontal() ? "right" : "bottom")), e.length && (e[0].style.opacity = Math.max(-n, 0)), s.length && (s[0].style.opacity = Math.max(n, 0))
                    }
            ...
            setTransition: e => {
                ...
                (s ? t.slides.find(s) : t.slides).transition(e).find(".swiper-slide-shadow-top, .swiper-slide-shadow-right, .swiper-slide-shadow-bottom, .swiper-slide-shadow-left").transition(e), K({
                    swiper: t,
                    duration: e,
                    transformEl: s
                })
        ...
        s({
            ...
            setTranslate: () => {
                ...
                for (let e = 0, t = a.length; e < t; e += 1) {
                    ...
                    if (U(r, t).transform(b), t[0].style.zIndex = 1 - Math.abs(Math.round(p)), r.slideShadows) {
                        let e = n ? t.find(".swiper-slide-shadow-left") : t.find(".swiper-slide-shadow-top"),
                            s = n ? t.find(".swiper-slide-shadow-right") : t.find(".swiper-slide-shadow-bottom");
                        0 === e.length && (e = Z(r, t, n ? "left" : "top")), 0 === s.length && (s = Z(r, t, n ? "right" : "bottom")), e.length && (e[0].style.opacity = p > 0 ? p : 0), s.length && (s[0].style.opacity = -p > 0 ? -p : 0)
                    }
                }
            },
            setTransition: e => {
        ...
        F({
            ...
            setTranslate: () => {
                ...
                for (let s = 0; s < e.length; s += 1) {
                    ...
                    if (m && f.shadow || !m) {
                        ...
                        if (0 === e.length && f.shadow && (e = Z(r, a)), e.length) {
            ...
            setTransition: e => {
                ...
                (s ? t.slides.find(s) : t.slides).transition(e).find(".swiper-slide-shadow").transition(e), K({
                    swiper: t,
                    duration: e,
                    transformEl: s,
                    allSlides: !0
        ...
        s({
            ...
            setTranslate: () => {
                ...
                for (let l = 0; l < e.length; l += 1) {
                    ...
                    o[0].style.zIndex = -Math.abs(Math.round(d)) + e.length, U(a, o).transform(y)
                }
            },
            setTransition: e => {
                const {
